            ...
            <div className="card bg-base-100 w-full max-w-lg shrink-0 shadow-2xl rounded p-10">
                ...
                <div className="card-body p-3">
                    <form className="fieldset">
                        ...
                        <input type="text" className="input w-full bg-gray-100" placeholder="name" />

                        <label className=" label">Photo </label>
                        <input type="text" className="input w-full bg-gray-100" placeholder="Photo url" />
                        ...
                        <div className='mt-4 flex gap-2 '> <input  type="checkbox" name="term" /> <a className="">Accept Term & Conditions</a></div>
